                        ...
                        <table class="shop_table cart">
                            ...
                            @foreach (Cart::content() as $product)
                                <tr class="cart_item">
                                    ...
                                    <a href="{{route('cart.remove',['rowId'=>$product->rowId])}}" class="product-del remove" title="Remove this item">
                                    ...
                                    <td class="product-quantity">
                                        ...
                                        <div class="quantity">
                                        <a href="{{route('cart.increment',['rowId'=>$product->rowId,'quantity'=>$product->qty])}}" class="quantity-minus quantity-minus-d">-</a>
                                             <input title="Qty" class="email input-text qty text" value="{{$product->qty}}" type="text" placeholder="1" readonly>
                                        <a href="{{route('cart.decrement',['rowId'=>$product->rowId,'quantity'=>$product->qty])}}" class="quantity-plus quantity-plus-d">+</a>
                                        </div>

                                    </td>

                                    <td class="product-subtotal">
                                    <h5 class="total amount">${{($product->qty)*($product->price)}}</h5>
                                    </td>
